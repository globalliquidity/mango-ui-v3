import {
  ...
  IExchangeAsset,
  ITradingPair,
} from '../TradeSerumInterface'
import { ExchangeAsset } from './ExchangeAsset'
import { TradingPair } from './TradingPair'

export class Exchange implements IExchange {
  constructor(
    public info: IExchangeInfo,
    public exchangeAssets: Array<IExchangeAsset> = [],
    public tradingPairs: Array<ITradingPair> = []
  ) {}
