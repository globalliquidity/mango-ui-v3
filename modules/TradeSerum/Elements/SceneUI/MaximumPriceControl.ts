...
export class MaximumPriceControl extends UIControl {
  ...
  protected onPreRender() {
    ...
    const maximumPrice: currency | undefined =
      PriceDivisionManager.Instance.currentPriceDivisionSetting?.maximumPrice

    if (maximumPrice) {
      this.priceLabel?.setText(maximumPrice.toString())
    }
  }
}
